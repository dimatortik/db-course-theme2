...
*Типи даних та способи їх збереження(як і локально так і хмарні рішення)*  
...
*Аналіз даних( підходи або окремі системи)*  
...
*Візуалізація (підходи або системи, біблотеки та інший софт)*
...
| Вимоги | Наш проєкт | Grapminder | DataBank | G.P.D.E | Poland Stat. | EuroStat. | Dataverse |
|-------------|-------------|-------------|-------------|-------------|-------------|-------------|-------------|
| Functionality |  |  |  |  |  |  |  |
| Візуалізація даних | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| Ліцензійність | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| Performance |  |  |  |  |  |  |  |
| Стійкість у разі неполадок/збоїв | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
